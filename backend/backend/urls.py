...
from api.views import create_rendez_vous, get_consultations_patient, get_patient_info, get_patient_par_medecin, register_medecin, register_patient_by_medecin, rendez_vous_medecin, update_patient, user_login
